import { ChangeAddressModal, Modal } from "@/components/common/modal"
import { AddressModal } from "./address-modal"

export const Address = () => {

  return <div className="hover:bg-gray-50 border-b border-gray-300 pb-6 flex justify-between items-start transition-colors cursor-pointer">
    <div>
